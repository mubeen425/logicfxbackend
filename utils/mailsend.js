...
sgMail.setApiKey(
  "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"
);

function send(to, subject, text, verifyToken) {
  const msg = {
    to: "sulaimanfarooqi526@gmail.com", // Change to your recipient
    from: "logicsyard@gmail.com", // Change to your verified sender
